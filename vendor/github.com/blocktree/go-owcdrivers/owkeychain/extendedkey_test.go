...
import (
	...
	"github.com/blocktree/go-owcdrivers/wavesTransaction"
...
func Test_ed25519_extend(t *testing.T) {
	...
	//path := "m/44'/88'/1'"
	seed, _ := hex.DecodeString("c185e3b00fc010c6d24402694f1f50fe55344b19fc29069a8e279fb5c0313338dab28948d2dc8b41a28658734248e8d649c37ebcca6ec48a69f6d21fe48e7d16")
	//path := "m/44'/88'/1'/0/0"
	...
	if err != nil {
		...
		fmt.Println("pkey : ", "DVXJ5jPzXvpp9ffVjrd6qNUnYzTgqgFNKGxD4AJrCZBy")

		fmt.Println("pkey : ", base58.Encode(pkey.key))
	...
	var pk wavesTransaction.PublicKey

	copy(pk[:], ppub.key[:])
	addr, err := wavesTransaction.NewAddressFromPublicKey(wavesTransaction.MainNetScheme, pk)
	if err != nil {
...
func Test_ed25519_nem(t *testing.T) {
	...
	childKeyed25519, _ := ed25519WalletKey.NewNEMWalletKeyFromMasterKey(seed, path)
	fmt.Println("childKeyed25519 = ", childKeyed25519)
	fmt.Println(hex.EncodeToString(childKeyed25519.Key.PrivateKey))

	fmt.Println("pri = ", hex.EncodeToString(childKeyed25519.Key.PrivateKey))
	fmt.Println("pri = ", "be052e8d052f25c5950375f520c39a5d80d0885a57aa98c2d30a50286734b099")
}
func Test_ed25519_algo(t *testing.T) {
	seed, _ := hex.DecodeString("c185e3b00fc010c6d24402694f1f50fe55344b19fc29069a8e279fb5c0313338dab28948d2dc8b41a28658734248e8d649c37ebcca6ec48a69f6d21fe48e7d16")
	//path := "m/44'/88'/1'/0/0"
	path := "m/44'/283'/0'/0'/0'"
	...
	if err != nil {
		...
		fmt.Println("ppub = ", hex.EncodeToString(childKey.Key.PublicKey))
	}
}
func Test_ed25519_algo_extend(t *testing.T) {
	...
	ppub := pkey.GetPublicKey()
	address, err := algoDecoder.AddressEncode(ppub.GetPublicKeyBytes())
	fmt.Println("address = ", address)
	if err != nil {
		t.Error("产生失败! ")
	} else {
		fmt.Println("ppub = ", hex.EncodeToString(ppub.key))
	}
